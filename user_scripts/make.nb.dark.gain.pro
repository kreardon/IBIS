...
base_dir     = '/SMdata1/kreardon/IBIS/Apr2017/'
...
; should be automated...
ca8542_flat_series   = ['20170421_192733','20170421_180800']
...
flat_file_nb = File_Search(ave_ser_dir,'FlatFieldCalibration.' + narrowband_tag + '*' + flat_series + '*.sav',count=num_flat_nb)
        ...
        prefilter_file = 'prefilter.' + STRING(ROUND(waveref),FORMAT='(I4.4)') + '.reference.profile.Apr2015.sav'
        RESTORE,Verbose=restore_verbose,'~kreardon/git/IBIS/prefilter_reference/' + prefilter_file
        ...
        flat_linepos             = find_line_shifts(flat_seq, flat_waves, wavelength_scale_interp=flat_wave_interp,$
                                       line_start=FIX(num_wave*0.1)+1,line_end=FIX(num_wave*0.9),$
